...
- Achieves **53% accuracy** on the validation dataset
...
- Public breed-detection API deployed on Hugging Face Spaces
- Supports authenticated access using user-provided Hugging Face tokens
